...
class CreateUserPage:
    ...
    def test_user_create_success(self, name, job):
    ...
    def test_user_create_success_without_name(self):
        job = "trader"
    ...
    def test_user_create_success_without_job(self):
        name = "John"
    ...
    def test_user_create_success_without_params(self):
        payload = {}
    ...
    def test_user_create_success_schema_validate(self, name, job):
